# Recolección LinkedIn GenAI — CORRIDA 3 de 3
...
1. `Copilot`
2. `RAG`
3. `WhatsApp IA atención al cliente`
4. `evals evaluación agentes`
...
* identificador consecutivo (esta corrida: 3xx → 301, 302, …);
* **tipo**;
* búsqueda de origen;
* fecha;
* autor;
...
Guardá el archivo: `linkedin_genai_corrida3.md`

Encabezado:

```
# Relevamiento LinkedIn GenAI — Corrida 3 de 3
- Fecha de ejecución:
- Búsquedas: Copilot, RAG, WhatsApp IA atención al cliente, evals evaluación agentes
- Estado de sesión:
