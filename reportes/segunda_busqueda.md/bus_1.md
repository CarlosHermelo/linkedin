# Recolección LinkedIn GenAI — CORRIDA 1 de 3
...
* identificador consecutivo (esta corrida: 1xx → 101, 102, …);
* **tipo**;
* búsqueda de origen;
* fecha;
* autor;
...
Guardá el archivo: `linkedin_genai_corrida1.md`

Encabezado:

```
# Relevamiento LinkedIn GenAI — Corrida 1 de 3
- Fecha de ejecución:
- Búsquedas: IA generativa, agentes de IA, ChatGPT, automatización con IA
- Estado de sesión:
